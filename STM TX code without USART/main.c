...
//			do {
//				transmissionStatus = TM_NRF24L01_GetTransmissionStatus();  /* Get transmission status */
//			} while (transmissionStatus == TM_NRF24L01_Transmit_Status_Sending);
			...
			Delayms(100); //Delay for control
			//Delay is in microseconds. This is in milli. Takes 10 seconds for value=1000. Put value= 100 for 1 second.
		//}
	}
}
